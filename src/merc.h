...
#define MAX_CLAN                   11
#define MAX_ART                    12
#define OPTIMISED_PFILES            0 /* Set to 0 for full length pfiles */
#include "board.h"
...
struct	descriptor_data
{
    ...
    int  autoansi;	/* for detecting ANSI color support */
    void *              pEdit;		/* OLC */
    char **             pString;	/* OLC */
};
...
#define PLR_WATCHER	       16777216
#define PLR_LAST_AGG	       33554432
#define PLR_MAP                67108864
...
#define EXTRA_STANCE          536870912 /* For autostance - Kai */
/*
...
#define CLAN_LIST	"../txt/clan1.txt"	/* List of clans		*/
#define ART_LIST	"../txt/art1.txt"	/* List of artifacts            */
...
#define NOTE_FILE	"../txt/notes.txt"	/* For 'notes'			*/
#define SHUTDOWN_FILE	"../txt/shutdown.txt"	/* For 'shutdown'		*/
#define DISABLED_FILE	"../txt/disabled.txt"	/* For 'disable'		*/
#define CHANGES_FILE    "../txt/changes.dat"  /* Needed for Changes list */
#define SHUTDOWN_FILE   "../txt/shutdown.txt"  /* Needed for Shutdown and startup script */
...
void do_ccenter			args ((CHAR_DATA * ch, char *argument));
